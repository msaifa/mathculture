...
<head>
    ...
    <style>
        body{
            background-image: url("img/materi/Materi10-8(dengan background).png");
...
<table width="100%" height="601" border="0" cellpadding="5" cellspacing="1">
  <tr>
    <td width="9%"><a href="materi10-7.php"><img src="img/Button-Back.png" width="90" height="90" border="0" /></a></td>
    <td height="20%">&nbsp;</td>
