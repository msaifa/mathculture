...
<div id="wadahChekbox">
  ...
  <div id="wadahChekbox2">
    <div><a href="B<?= $soalno ?>.php?answer=C"><img src="<?= $jawabanKu == 'C' ? 'img/button_opsi2.png' : 'img/button_opsi.png'?>" width="8%" height="4%"/></a></div>
    <div><a href="B<?= $soalno ?>.php?answer=D"><img src="<?= $jawabanKu == 'D' ? 'img/button_opsi2.png' : 'img/button_opsi.png'?>" width="8%" height="4%"/></a></div>  
  </div>  
